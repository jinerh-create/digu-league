          ...
          <div key={p.id} className="card" style={{ display: 'flex', alignItems: 'center', gap: '0.875rem', padding: '0.875rem 1rem', border: '1.5px solid rgba(212,175,55,0.45)', boxShadow: '0 0 14px rgba(212,175,55,0.1), inset 0 1px 0 rgba(212,175,55,0.08)', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              {editingId === p.id ? (
                ...
                <>
                  <div style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", fontWeight: 700, fontSize: 'clamp(0.82rem, 3.6vw, 1.1rem)', letterSpacing: '0.02em', color: 'var(--gold, #FFD700)', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '0.3rem', whiteSpace: 'nowrap', minWidth: 0 }}>
