                  ...
                  <div className="hof-card" style={{
                    ...
                    {playerOfMonth && (
                      <div style={{
                        ...
                        {/* Title pill */}
                        <div style={{ background:'linear-gradient(135deg,rgba(212,175,55,0.3),rgba(212,175,55,0.15))',border:'1.5px solid rgba(212,175,55,0.6)',borderRadius:20,padding:'3px 12px',fontFamily:"'Manrope',sans-serif",fontSize:'0.5625rem',fontWeight:900,color:'#D4AF37',letterSpacing:'0.12em',textTransform:'uppercase',marginBottom:'0.5rem' }}>
                          CHAMPION
                        </div>
                        {/* Name */}
                        <div style={{ fontFamily:"'Sora',sans-serif",fontSize:'1.0625rem',fontWeight:900,color:'#fff',textAlign:'center',lineHeight:1.15,marginBottom:2 }}>
                          {playerOfMonth.nickname || playerOfMonth.name.split(' ')[0]}
                        </div>
                        {playerOfMonth.nickname && (
                          <div style={{ fontSize:'0.5625rem',color:'rgba(200,180,140,0.45)',fontFamily:"'Manrope',sans-serif",marginBottom:'0.625rem',textAlign:'center' }}>
                            {playerOfMonth.name}
                          </div>
                        )}
                        {/* Stat */}
                        <div style={{ background:'linear-gradient(135deg,rgba(212,175,55,0.25),rgba(212,175,55,0.1))',border:'2px solid rgba(212,175,55,0.6)',borderRadius:20,padding:'4px 14px',fontSize:'0.6875rem',fontWeight:900,color:'#D4AF37',fontFamily:"'Sora',sans-serif",boxShadow:'0 0 10px rgba(212,175,55,0.2)' }}>
                    ...
                    <div style={{
                      ...
                      <div style={{ fontSize:'0.5rem',color:'rgba(212,175,55,0.3)',fontFamily:"'Manrope',sans-serif",marginTop:2 }}>
                    ...
                    {diguKing && diguKing.gin_count > 0 && (
                      <div style={{
                        ...
                        {/* Title pill */}
                        <div style={{ background:'linear-gradient(135deg,rgba(200,16,46,0.3),rgba(200,16,46,0.15))',border:'1.5px solid rgba(200,16,46,0.6)',borderRadius:20,padding:'3px 12px',fontFamily:"'Manrope',sans-serif",fontSize:'0.5625rem',fontWeight:900,color:'#FF4A6A',letterSpacing:'0.12em',textTransform:'uppercase',marginBottom:'0.5rem' }}>
                          DIGU KING
                        </div>
                        {/* Name */}
                        <div style={{ fontFamily:"'Sora',sans-serif",fontSize:'1.0625rem',fontWeight:900,color:'#fff',textAlign:'center',lineHeight:1.15,marginBottom:2 }}>
                        ...
                        {/* Stat */}
                        <div style={{ background:'linear-gradient(135deg,rgba(200,16,46,0.25),rgba(200,16,46,0.1))',border:'2px solid rgba(200,16,46,0.6)',borderRadius:20,padding:'4px 14px',fontSize:'0.6875rem',fontWeight:900,color:'#FF4A6A',fontFamily:"'Sora',sans-serif",boxShadow:'0 0 10px rgba(200,16,46,0.2)' }}>
